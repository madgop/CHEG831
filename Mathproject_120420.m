...
% Each row is a set of initial conditions
% Columns correspond to proteins M, P0, P1, P2, and PN, respectively
...
for j=1:rows
    P_t(j,1)=(sum(P_Conc(j,2:5)));  % Calculate total PER protein, eq. 2 in paper
end
...
% Equations 1a through 1e of paper below; preallocate matrix here
P_Conc=zeros(5,1);
