...
% Subsitute y variable for parameter being analyzed in f and jac, 
% which is v_d here
...
% dfdv_d is the df/dp vector that we solve for in parametric continuation
% Equation for parametric continuation is: Jacobian*dz/dp = -df/dp 
% Form is dfdv_d = [df1/dvd; df2/dvd; df3/dvd; df4/dvd; df5/dvd] 
...
k = 1;
i = 1;
% Form for ODE solver is ode45(function, time_span, init_cond)
